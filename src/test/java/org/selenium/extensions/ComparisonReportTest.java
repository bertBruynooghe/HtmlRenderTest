...
import static org.selenium.extensions.ImageComparisonAssert.assertImageEquals;
...
public class ComparisonReportTest {
    ...
    public void testResolveHtml() throws Exception{
        report.store(STORAGE_LOCATION, "x", DIFFERENCE_FILENAME_PLACEHOLDER +
    ...
    public void testHtmlLocation() throws Exception{
        String location = report.store(STORAGE_LOCATION, "x", "");
        assertEquals("x/" + REPORT_FILE_NAME, location);
    }
